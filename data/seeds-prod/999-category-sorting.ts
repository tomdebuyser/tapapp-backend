...
const entityName = 'CategorySorting';
const path = `${__dirname}/category-sorting.json`;
const data = JSON.parse(readFileSync(path).toString());

export class CategorySortingSeeds1578312827200 implements MigrationInterface {
